export default class HackUtils {
  static updateLog(ns: NS, portData: any, target: string, batch: {hackThreads?: number; growThreads?: number; weakenThreads?: number}, action?: boolean): void {
    const data = {
      target,
    ...
    portData.write(JSON.stringify(data));
  }
